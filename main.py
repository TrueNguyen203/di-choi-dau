...
icon = pygame.image.load("motoicon.png")
pygame.display.set_icon(icon)
#Moto image
motoImp =  pygame.image.load("motocross.png")
motocx = 150
motocy = 560
motocx_change = 0
motocy_change = 0
...
#Game image
gamestaImp = pygame.image.load("gamestation.png")
#Drawing game station
def game_station():
    screen.blit(gamestaImp, (925, 475))

#Event image
eventImp = pygame.image.load("eventstation.png")
#Drawing event station
def event_station():
    screen.blit(eventImp, (925, 650))

#Road image
roadImp = pygame.image.load("road.png")
#Drawing road
def road(x,y):
    screen.blit(roadImp, (x, y))

#backgroud
bgImp = pygame.image.load("backgroud.png")
def backgroud():
...
#Title
#font = pygame.font.Font("/Users/Macbook/Documents/Second year/project for PyC/FreeSansBold.tff", 32)
#def showtitle():
